...
const originals = [
    { id: 1, title: "Handcrafted Dreams | Original Artwork", price: "₹ 7999", image: kaarigar1, link: "#" },
    { id: 2, title: "Soulful Symphony | Canvas Masterpiece", price: "₹ 6499", image: kaarigar2, link: "#" },
    { id: 3, title: "Mystic Reflections | Paper Original", price: "₹ 7299", image: kaarigar3, link: "#" },
    {
        id: 4,
    ...
    { id: 6, title: "Twilight Reverie | Exclusive Paper", price: "₹ 7399", image: Img6, link: "#" },
    { id: 7, title: "Golden Horizon | Limited Series", price: "₹ 8599", image: Img7, link: "#" },
    { id: 8, title: "Crimson Threads | Canvas Abstract", price: "₹ 7999", image: Img8, link: "#" },
    { id: 9, title: "Ethereal Touch | Fine Original", price: "₹ 7499", image: Img9, link: "#" },
    { id: 10, title: "Twilight Reverie | Exclusive Paper", price: "₹ 7399", image: Img10, link: "#" },
    { id: 11, title: "Golden Horizon | Limited Series", price: "₹ 8599", image: Img11, link: "#" },
    { id: 12, title: "Crimson Threads | Canvas Abstract", price: "₹ 7999", image: Img12, link: "#" },
    { id: 13, title: "Ethereal Touch | Fine Original", price: "₹ 7499", image: Img13, link: "#" },
];
    ...
    return (
        <section className="relative overflow-hidden min-h-screen bg-white py-20 px-6 md:px-16">
            ...
            <div className="absolute inset-0">
                <img src={bgImg} alt="Background" className="w-full h-full object-cover opacity-70 blur-none" />
      ...
      ${product.hoverImage ? "group-hover:opacity-0 object-contain" : "object-cover"}`}
                                    />
                                ...
                                <div className="p-4 text-center">
                                    <h3 className="text-xl font-[Amita] font-bold text-gray-800 mb-2">{product.title}</h3>
                                    <p className="text-teal-600 font-semibold text-lg">{product.price}</p>
                                    <p className="text-gray-500 text-sm mt-1">Exclusive Originals</p>
                                </div>
                            </a>
                        </TiltCard>
                    </motion.div>

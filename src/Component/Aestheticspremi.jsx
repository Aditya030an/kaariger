...
const originals = [
  ...
  { id: 5, title: "Mystic Reflections | Paper Original", price: "₹ 7299", image: Img5, link: "#" },
  { id: 6, title: "Mystic Reflections | Paper Original", price: "₹ 7299", image: Img6, link: "#" },

  { id: 9, title: "Mystic Reflections | Paper Original", price: "₹ 7299", image: Img8, link: "#" },
  { id: 8, title: "Mystic Reflections | Paper Original", price: "₹ 7299", image: Img9, link: "#" },
  ...
  return (
    <section className="relative overflow-hidden min-h-screen bg-black py-20 px-6 md:px-16">
      ...
      <div className="absolute inset-0">
        <img src={bgImg} alt="Background" className="w-full h-full object-cover opacity-45 blur-sm" />
